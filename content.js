...
(function () {
  ...
  // ✅ Sentence Enders - বাংলা বাক্য শেষ হওয়ার সাধারণ শব্দ
  const BN_SENTENCE_ENDERS = [
    // মূল ভার্ব এন্ডিংস (Present/Past/Future/Continuous)
    'করুন', 'করে', 'করল', 'করবে', 'করছি', 'করছেন', 'করছিল', 'করবেন',
    'করলাম', 'করলেন', 'করবো', 'করছো', 'করলি', 'করেছি', 'করেছেন', 'করেছিল',

    'হয়', 'হয়ে', 'হলো', 'হবে', 'হচ্ছে', 'হচ্ছিল', 'হবেন', 'হবো', 'হলাম', 'হলেন', 'হয়েছে', 'হয়েছিল',
    'আছে', 'ছিল', 'থাকে', 'থাকল', 'থাকবে', 'থাকছি', 'থাকছেন', 'থাকলো', 'থাকবো', 'থেকেছে',

    'যান', 'যায়', 'গেল', 'যাবে', 'যাচ্ছে', 'যাচ্ছিল', 'যাবেন', 'যাবো', 'গেছে', 'গিয়েছে', 'যাও',
    'আসুন', 'আসে', 'এলো', 'আসবে', 'আসছি', 'আসছেন', 'আসলো', 'আসবো', 'এসেছে', 'এসেছিল',

    'বলুন', 'বলে', 'বলল', 'বলবে', 'বলছি', 'বলছেন', 'বললো', 'বলবো', 'বলেছে', 'বলেছিল',
    'দেখুন', 'দেখে', 'দেখল', 'দেখবে', 'দেখছি', 'দেখছেন', 'দেখলো', 'দেখবো', 'দেখেছে',
    'শুনুন', 'শুনে', 'শুনল', 'শুনবে', 'শুনছি', 'শুনছেন', 'শুনলো', 'শুনবো', 'শুনেছে',
    'পড়ুন', 'পড়ে', 'পড়ল', 'পড়বে', 'পড়ছি', 'পড়ছেন', 'পড়লো', 'পড়বো', 'পড়েছে',
    'লিখুন', 'লেখে', 'লিখল', 'লিখবে', 'লিখছি', 'লিখছেন', 'লিখলো', 'লিখবো', 'লিখেছে',
    'জানুন', 'জানে', 'জানল', 'জানবে', 'জানছি', 'জানছেন', 'জানলো', 'জানবো', 'জেনেছে',
    'বুঝুন', 'বোঝে', 'বুঝল', 'বুঝবে', 'বুঝছি', 'বুঝছেন', 'বুঝলো', 'বুঝবো', 'বুঝেছে',

    'দিন', 'নিন', 'গ্রহণ করুন', 'দেয়', 'দিল', 'দিবে', 'দিচ্ছে', 'দিবেন', 'দিবো', 'দিয়েছে',
    'নেয়', 'নিল', 'নিবে', 'নিচ্ছে', 'নিবেন', 'নিবো', 'নিয়েছে',
    'খায়', 'খেল', 'খাবে', 'খাচ্ছে', 'খাবেন', 'খাবো', 'খেয়েছে',
    'পায়', 'পেল', 'পাবে', 'পাচ্ছে', 'পাবেন', 'পাবো', 'পেয়েছে',
    'চায়', 'চাইল', 'চাইবে', 'চাইছি', 'চাইবেন', 'চাইবো', 'চেয়েছে',
    'পারে', 'পারল', 'পারবে', 'পারছি', 'পারছেন', 'পারবো', 'পেরেছে',
    'লাগে', 'লাগল', 'লাগবে', 'লাগছে', 'লাগবেন', 'লাগবো', 'লেগেছে',

    // Common expressions & particles
    'ঠিক', 'ঠিক আছে', 'ভালো', 'ভালো আছে', 'খারাপ', 'খারাপ লাগে',
    'ধন্যবাদ', 'শুভেচ্ছা', 'অনুগ্রহ', 'দয়া', 'প্লিজ', 'অনুগ্রহ করে', 'দয়া করে',
    'প্রয়োজন', 'দরকার', 'উচিত', 'আবশ্যক', 'জরুরি', 'জরুরী',
    'সম্ভব', 'অসম্ভব', 'সম্ভবত', 'নিশ্চয়', 'অবশ্যই', 'হয়তো', 'বোধহয়', 'নিশ্চিত',
    'তাই', 'তবে', 'কিন্তু', 'এবং', 'অথবা', 'অথচ', 'আর', 'আরও', 'আরো',
    'শুধু', 'কেবল', 'মাত্র', 'অবশ্য', 'সত্যি', 'সত্যিই', 'আসলে', 'আসলেই',
    'বেশ', 'খুব', 'অত্যন্ত', 'অতি', 'একটু', 'কিছুটা', 'অনেক', 'কম', 'বেশি',
    'সব', 'সবাই', 'কেউ', 'প্রায়', 'প্রায়ই', 'সম্পূর্ণ', 'পুরো',

    // Time & place markers that often end sentences
    'এখন', 'আজ', 'কাল', 'পরশু', 'সকাল', 'দুপুর', 'বিকাল', 'সন্ধ্যা', 'রাত', 'আজকে', 'কালকে',
    'আগে', 'পরে', 'মধ্যে', 'ভেতরে', 'বাইরে', 'উপরে', 'নিচে', 'সামনে', 'পিছনে', 'পাশে', 'কাছে', 'দূরে',

    // Connectors & postpositions
    'সাথে', 'ছাড়া', 'ব্যতীত', 'সহ', 'জন্য', 'কারণে', 'ফলে', 'ফলেই',
    'মত', 'মতো', 'হিসেবে', 'হিসেবেই', 'নিয়ে', 'নিয়েই', 'দিয়ে', 'দিয়েই',
    'হয়ে', 'হয়েই', 'হয়েও', 'বলে', 'বলেই', 'বলেও', 'করে', 'করেই', 'করেও',

    // Mental state expressions
    'মনে', 'মনে হয়', 'মনে হচ্ছে', 'মনে হলো', 'মনে করি', 'মনে করছেন',

    // Polite imperatives
    'বলুন', 'দেখুন', 'পড়ুন', 'লিখুন', 'শুনুন', 'জানুন', 'বুঝুন', 'করুন', 'নিন', 'যান', 'আসুন', 'দিন'
  ];

  // ❓ Question Words - বাংলা প্রশ্নবোধক শব্দ
  const BN_QUESTION_WORDS = [
    // Basic question words
    'কি', 'কী', 'কেন', 'কোথায়', 'কখন', 'কিভাবে', 'কীভাবে', 'কে', 'কার', 'কাকে', 'কাদের', 'কোন', 'কতটুকু', 'কতজন',

    // Extended question forms
    'কিসের', 'কীসের', 'কারা', 'কাদেরকে', 'কোনটা', 'কোনটি', 'কোনগুলো', 'কোনগুলি', 'কোনখান', 'কোনদিক',
    'কত', 'কতগুলো', 'কতগুলি', 'কতবার', 'কতদিন', 'কতক্ষণ', 'কতদূর', 'কতটা',
    'কেননা', 'কিসের জন্য', 'কী জন্য', 'কার জন্য', 'কোন কারণে',
    'কি করে', 'কী করে', 'কেমন', 'কেমন করে', 'কেমনভাবে',
    'কিসে', 'কীসে', 'কোন্', 'কোন্টা', 'কোন্টি', 'কোন্গুলো',

    // Question + verb combinations (very common in daily use)
    'কি করব', 'কী করব', 'কি করবো', 'কী করবো', 'কি করছ', 'কী করছ', 'কি করছো', 'কী করছো',
    'কি করল', 'কী করল', 'কি করলে', 'কী করলে', 'কি হবে', 'কী হবে', 'কি হবে',
    'কি আছে', 'কী আছে', 'কি ছিল', 'কী ছিল', 'কি নেই', 'কী নেই',

    'কেন করলে', 'কেন করলি', 'কেন করলেন', 'কেন আসছ', 'কেন আসছো', 'কেন আসছেন',
    'কেন যাচ্ছ', 'কেন যাচ্ছো', 'কেন যাচ্ছেন', 'কেন করবে', 'কেন করব',

    'কোথায় যাচ্ছ', 'কোথায় যাচ্ছো', 'কোথায় যাচ্ছেন', 'কোথায় আসছ', 'কোথায় আসছো', 'কোথায় আসছেন',
    'কোথায় যাব', 'কোথায় যাবো', 'কোথায় থাকব', 'কোথায় থাকবে',

    'কখন আসবে', 'কখন যাবে', 'কখন করবে', 'কখন করল', 'কখন করলে', 'কখন করবেন',
    'কখন আসব', 'কখন যাব', 'কখন আসছ', 'কখন যাচ্ছ',

    'কিভাবে করব', 'কীভাবে করব', 'কিভাবে করবো', 'কীভাবে করবো',
    'কিভাবে করছ', 'কীভাবে করছ', 'কিভাবে করছো', 'কীভাবে করছো',
    'কিভাবে করল', 'কীভাবে করল', 'কিভাবে হবে', 'কীভাবে হবে',

    'কে আসবে', 'কে যাবে', 'কে করবে', 'কে করল', 'কে করলে', 'কে করবেন',
    'কে এসেছে', 'কে গেছে', 'কে বলেছে', 'কে জানে', 'কে বুঝেছে',

    'কার সাথে', 'কার জন্য', 'কার কারণে', 'কার কাছে', 'কার কাছ থেকে',
    'কাকে দিব', 'কাকে দিবো', 'কাকে দিবেন', 'কাকে বলব', 'কাকে বলবো',

    'কোনটা ভালো', 'কোনটি ভালো', 'কোনগুলো ভালো',
    'কোনটা ঠিক', 'কোনটি ঠিক', 'কোনগুলো ঠিক',
    'কোনটা চাই', 'কোনটি চাই', 'কোনটা লাগবে',

    // Question particles & emphasis
    'কি না', 'কী না', 'কিংবা না', 'কি বলো', 'কী বলো', 'কি বল', 'কী বল',
    'কিভাবেই', 'কীভাবেই', 'কেনই বা', 'কোথায়ই বা', 'কখনই বা',
    'কেই বা', 'কারই বা', 'কাকেই বা', 'কোনটাই', 'কোনটিই',

    // Past perfect question forms (very frequent)
    'খেয়েছ', 'খেয়েছো', 'খেয়েছেন', 'করেছ', 'করেছো', 'করেছেন',
    'গেছ', 'গেছো', 'গেছেন', 'এসেছ', 'এসেছো', 'এসেছেন',
    'দেখেছ', 'দেখেছো', 'দেখেছেন', 'শুনেছ', 'শুনেছো', 'শুনেছেন',
    'জেনেছ', 'জেনেছো', 'জেনেছেন', 'বুঝেছ', 'বুঝেছো', 'বুঝেছেন',
    'পড়েছ', 'পড়েছো', 'পড়েছেন', 'লিখেছ', 'লিখেছো', 'লিখেছেন',
    'বলেছ', 'বলেছো', 'বলেছেন', 'নিয়েছ', 'নিয়েছো', 'নিয়েছেন',
    'দিয়েছ', 'দিয়েছো', 'দিয়েছেন', 'পেয়েছ', 'পেয়েছো', 'পেয়েছেন',

    // Continuous question forms
    'পাচ্ছ', 'পাচ্ছো', 'পাচ্ছেন', 'থাকছ', 'থাকছো', 'থাকছেন',
    'পারছ', 'পারছো', 'পারছেন', 'লাগছ', 'লাগছো', 'লাগছেন',
    'চাচ্ছ', 'চাচ্ছো', 'চাচ্ছেন', 'খাচ্ছ', 'খাচ্ছো', 'খাচ্ছেন'
  ];
